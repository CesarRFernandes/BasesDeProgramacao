...
public class Janela extends JFrame implements ActionListener {
    ...
    private ImageIcon imgElefante1;
    private ImageIcon imgElefante2;
    private ImageIcon imgElefante3;
    ...
    public Janela() {
        ...
        imgElefante1 = new ImageIcon("./src/imagens/elefante1.png");
        imgElefante2 = new ImageIcon("./src/imagens/elefante2.png");
        imgElefante3 = new ImageIcon("./src/imagens/elefante3.png");
     ...
     public JLabel JLabelElefantes(String nome, ImageIcon img, int posX, int posY) {
        ElefanteThread elefante = new ElefanteThread(nome, img, posX, posY);
        elefante.setSize(256, 141);
    ...
    public void actionPerformed(ActionEvent dispara) {
        if (dispara.getSource() == this.btnCorrida) {
            this.lblPista.add(JLabelElefantes("Elefante1", imgElefante1, 0, 50));
            this.lblPista.add(JLabelElefantes("Elefante2", imgElefante2, 0, 200));
            this.lblPista.add(JLabelElefantes("Elefante3", imgElefante3, 0, 350));
        }
